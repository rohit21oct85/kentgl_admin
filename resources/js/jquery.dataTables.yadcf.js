...
var output = '07/26/2016';

  $(filter_selector_string).append("<input onkeydown=\"yadcf.preventDefaultForEnter(event);\" value=\"" + output + "\" placeholder=\"" + filter_default_label[0] + "\" id=\"" + fromId + "\" class=\"yadcf-filter-range-date yadcf-filter-range\" " + filterActionStr + "></input>");*/
