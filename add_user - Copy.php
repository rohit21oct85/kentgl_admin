					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<input type="email" class="form-control" value="<?php echo $email; ?>" placeholder="Email" name="email" id="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" title="xyz@something.com" required>
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-md-3">Mobile</label>
								<div class="col-md-9">
									<input type="text" class="form-control" value="<?php echo $mobileno; ?>" placeholder="Mobile" maxlength="10" name="mobile" id="mobile" pattern="[789][0-9]{9}" required>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-9">
									...
									<select class="form-control" name="role" id="role" onchange="CheckReporting(this.value)" required>
										...
										<?php 
											...
											foreach($results['RoleList'] as $value){
											?>				
						...
						<div class="form-group">
								...
								<div class="col-md-9">
						<select class="form-control" onchange="CheckState(this.value);"  name="state" id="state_new" required>
						...
						<div class="form-group">
								...
								<div class="col-md-9" id="city_1">
									<select class="form-control select2me" data-placeholder="Select City" name="city" id="city" onchange="CheckCity(this.value);" required>
							...
							<div class="form-group"  id="city" style="display:none;">
								...
								<div class="col-md-9" style="float:right">
									<input type="text" class="form-control" value="" placeholder="city" name="city1">
...
$(document).ready(function(){
		...
		$("#addUser").click(function(){
			...
			if(name == ""){
				$("#name").css({'borderColor':'red'}).focus();
			}else if(email == ""){
				$("#email").css({'borderColor':'red'}).focus();	
			}else if(mobile == ""){
				$("#mobile").css({'borderColor':'red'}).focus();	
			}else if($("#role").val() == ""){
